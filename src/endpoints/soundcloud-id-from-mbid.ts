...
export const SoundcloudIdFromMbid = createGetPostPair({
  path: "/soundcloud-id-from-mbid/json",
  description: " Given a recording mbid, lookup its metadata using canonical metadata tables and using that attempt to find a suitable match in Soundcloud.",
  params:  z.object({
      ...
      "application/json": {
        schema: z.array(
          z.object({
            ...
            soundcloud_track_ids: z.array(z.string()).openapi({
              example: ["7db2c09d-345f-46e6-900e-0f4499e29c3d"],
            }),
          })
        )
